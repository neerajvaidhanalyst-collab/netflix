...
-- 1. Count the number of Movies vs TV Sho
...
-- 9. Count the number of content items in each genre
	...
	select unnest(string_to_array(listed_in,',')) as genore,
	count(show_id)
	from netflix
	group by genore;
...
13. Find the top 10 actors who have appeared in the highest number of movies produced in India.
	...
	select 
	unnest(string_to_array(casts,',')) as acters,
	count(*)
	from netflix
